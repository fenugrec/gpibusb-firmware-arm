 ...
 *
 * Since the hash code is generated by gperf, there's not much point in
 * validating that part. Its cmd_lookup() does bounds checking on string
 * length, and will never return a false match since it does a strncmp().
 *
 * Some tests in here are incorrectly tokenized inputs and belong
 * in a different test.
 */
